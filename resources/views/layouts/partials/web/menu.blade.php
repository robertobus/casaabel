    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="#"><img src="" class="img-responsive" alt="" /> Inicio</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6">
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <!-- Button -->
                                        <a href="" class="btn btn-danger btn-xs">Ver más</a>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <!-- Menu Item -->
                ...
                <!--
                <li><a href=""><img src="" class="img-responsive" alt="" /> Gallery</a></li>
                -->
                <!--
                <li class="dropdown">
