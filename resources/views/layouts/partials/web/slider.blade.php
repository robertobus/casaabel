    ...
    <div class="tp-banner" >
        <ul>	<!-- SLIDE  -->
            <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('theme_web/img/slider/img_slide_1.jpg') }}"  alt=""  data-bgfit="contain" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                <!-- LAYERS -->
                <!-- LAYER NR. 1 --
                ...
                <div class="tp-caption customin customout"
                     ...
                     data-endspeed="300"
                     style="z-index: 5"><img class="slide-img img-responsive" src="{{ asset('theme_web/img/slider/s21.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 3.1 --
                <div class="tp-caption customin customout"
                     ...
                     data-easing="Power3.easeInOut"
                     data-endspeed="300"
                     style="z-index: 6"><img class="slide-img img-responsive" src="{{ asset('theme_web/img/slider/s22.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 3.2 --
                <div class="tp-caption customin customout"
                     ...
                     data-easing="Power3.easeInOut"
                     data-endspeed="300"
                     style="z-index: 7"><img class="slide-img img-responsive" src="{{ asset('theme_web/img/slider/s23.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 3.3 --
                <div class="tp-caption customin customout"
                     ...
                     data-easing="Power3.easeInOut"
                     data-endspeed="300"
                     style="z-index: 8"><img class="slide-img img-responsive" src="{{ asset('theme_web/img/slider/s24.png') }}" alt="" />
                </div>-->
            </li>
            <li data-transition="zoomin" data-slotamount="6" data-masterspeed="400" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('theme_web/img/slider/transparent.png') }}" style="background-color:#fff" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                ...
                <div class="tp-caption customin customout"
                     ...
                     data-endspeed="500"
                     data-endeasing="Power4.easeIn"
                     style="z-index: 3"><img class="img-responsive" src="{{ asset('theme_web/img/slider/s11.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 2.1 -->
                <div class="tp-caption customin customout"
                     data-x="right"
                     ...
                     data-endspeed="500"
                     data-endeasing="Power4.easeIn"
                     style="z-index: 3"><img class="img-responsive" src="{{ asset('theme_web/img/slider/s12.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 2.2 -->
                <div class="tp-caption customin customout"
                     data-x="right"
                     ...
                     data-endspeed="500"
                     data-endeasing="Power4.easeIn"
                     style="z-index: 3"><img class="img-responsive" src="{{ asset('theme_web/img/slider/s13.png') }}" alt="" />
                </div>
                <!-- LAYER NR. 2.3 -->
            ...
            <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('theme_web/img/slider/transparent.png') }}" style="background-color:#fea501" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                <!-- LAYERS NR. 1 -->
                <div class="tp-caption lfl"
                     ...
                     data-captionhidden="off"><img class="img-responsive" src="{{ asset('theme_web/img/slider/s35.png') }}" alt="" />
                </div>
                <!-- LAYERS NR. 2 -->
            ...
            <li data-transition="cube" data-slotamount="7" data-masterspeed="600" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('theme_web/img/slider/slide2.jpg') }}"  alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                <!-- LAYERS NR. 1 -->
                <div class="tp-caption lfl"
                     data-x="110"
                     data-y="130"
                     ...
                     data-endspeed="300"
                     data-endeasing="Power4.easeIn"
                     data-captionhidden="off"><img src="{{ asset('theme_web/img/slider/s31.png') }}" class="img-responsive" alt="" />
                </div>
                <!-- LAYERS NR. 2 -->
                <div class="tp-caption lfl"
                     data-x="80"
                     ...
                     data-endspeed="300"
                     data-endeasing="Power4.easeIn"
                     data-captionhidden="off"><img src="{{ asset('theme_web/img/slider/s33.png') }}" class="img-responsive" alt="" />
                </div>
                <!-- LAYERS NR. 3 -->
                <div class="tp-caption lfl"
                     data-x="450"
                     ...
                     data-endspeed="300"
                     data-endeasing="Power4.easeIn"
                     data-captionhidden="off"><img src="{{ asset('theme_web/img/slider/s34.png') }}" class="img-responsive" alt="" />
                </div>
                <!-- LAYERS NR. 4 -->
