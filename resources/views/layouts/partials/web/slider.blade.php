    ...
    <div class="tp-banner" >
        <ul>	<!-- SLIDE  -->
            ...
            <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
                <!-- MAIN IMAGE -->
                <img src="{{ asset('theme_web/img/slider/transparent.png') }}" style="background-color:#44aae4" alt=""  data-bgfit="cover" data-bgposition="center bottom" data-bgrepeat="no-repeat">
                <!-- LAYERS NR. 1 -->
                ...
                <div class="tp-caption lfl"
                     ...
                     data-endspeed="300"
                     data-endeasing="Linear.easeNone"
                     data-captionhidden="off"><img class="img-responsive" style="width: 200%;" src="{{ asset('images/casaabel_logo.png') }}" alt="" />
                </div>
                <!-- LAYERS NR. 2 -->
            ...
            <li data-transition="slidehorizontal" data-slotamount="1" data-masterspeed="600" >
                ...
                <div class="tp-caption lfl"
                     ...
                     data-endspeed="300"
                     data-endeasing="Linear.easeNone"
                     data-captionhidden="off"><img class="img-responsive" style="width: 60%;" src="{{ asset('images/plancha.png') }}" alt="" />
                </div>
                <!-- LAYERS LOGO -->
                <div class="tp-caption lfl"
                     data-x="-100"
                ...
                <div class="tp-caption finewide_verysmall_white_mw white customin customout tp-resizeme text-right paragraph"
                     ...
                     data-endspeed="300"
                     style="z-index: 10; max-width: auto; max-height: auto; white-space: nowrap;">
                    <p>Ideal para aislar térmicamente muros, cubiertas inclinadas, cubiertas planas y por debajo de contrapisos.</p>
                    <p>Medidas: 1000 x 420 m/m</p>
                    <p>DENSIDADES: std. 15, 20, 25 y 30kg/m3.</p>
                </div>
            </li>
